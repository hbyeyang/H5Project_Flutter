...
class RequestHttp {
  static RequestHttp _instance;

//  static final String baseUrl = "http://111.230.251.115/oldchen/";
  static final String baseUrl = "http://t.channel.45xie.com/api/api?action=adapi";
  static const int connectTimeOut = 10 * 1000; //连接超时时间为10秒
  static const int receiveTimeOut = 15 * 1000; //响应超时时间为15秒

  Dio _client;

  static RequestHttp getInstance() {
    if (_instance == null) {
      _instance = RequestHttp._internal();
    }
    return _instance;
  }
